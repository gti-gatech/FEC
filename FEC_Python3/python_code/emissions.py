...
def get_emissions(cycle_name, number_of_passengers, cycle_location, year, road_type_id, source_type_id, hours_in_operation,
...
#    print egrid_df
    ...
    energy_sum_dict, fuel_type_dict, energy_consumption_dfs_dict = \
        energy_consumption.get_energy_consumption_values(cycle_name, number_of_passengers, cycle_location,
