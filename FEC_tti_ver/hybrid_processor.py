...
param_to_load = 'param/hybrid_param.csv'
hybrid_parameter = read_csv(param_to_load, sep = ',')
#print(hybrid_parameter.head(5))
BUS_LENGTH_PARALLEL = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'BUS_LENGTH_PARALLEL', 'Value'].values[0]
#BUS_WEIGHT_PARALLEL = c.SOURCE_MASS_METRIC_TONNES * c.HEV_TO_SI_CI_WEIGHT_FACTOR
SPD_WIN_1_MPH_PARALLEL = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'SPD_WIN_1_MPH_PARALLEL', 'Value'].values[0]
SPD_WIN_2_MPH_PARALLEL = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'SPD_WIN_2_MPH_PARALLEL', 'Value'].values[0]
SPD_WIN_3_MPH_PARALLEL = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'SPD_WIN_3_MPH_PARALLEL', 'Value'].values[0]
SPD_WIN_4_MPH_PARALLEL = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'SPD_WIN_4_MPH_PARALLEL', 'Value'].values[0]
ACC_THRSH_1_MPHS_PARALLEL = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'ACC_THRSH_1_MPHS_PARALLEL', 'Value'].values[0]
...
EM_CRUISE_BLEND_PARALLEL = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'EM_CRUISE_BLEND_PARALLEL', 'Value'].values[0]
GEN_COEFF_1_PARALLEL = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'GEN_COEFF_1_PARALLEL', 'Value'].values[0]
GEN_COEFF_2_PARALLEL = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'GEN_COEFF_2_PARALLEL', 'Value'].values[0]
SOC_BASE_PERCENT_PARALLEL = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'SOC_BASE_PERCENT_PARALLEL', 'Value'].values[0]
SOC_MIN_PERCENT_PARALLEL = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'SOC_MIN_PERCENT_PARALLEL', 'Value'].values[0]
SOC_DELTA_PERCENT_PARALLEL = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'SOC_DELTA_PERCENT_PARALLEL', 'Value'].values[0]
EPT_EFFICIENCY_PERCENT_PARALLEL = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'EPT_EFFICIENCY_PERCENT_PARALLEL', 'Value'].values[0]
EM_PWR_KW = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'EM_PWR_KW', 'Value'].values[0]
ENG_PWR_KW = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'ENG_PWR_KW', 'Value'].values[0]
BATT_CAP_KW_SEC = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'BATT_CAP_KW_SEC', 'Value'].values[0]
SOC_START_VALUE = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'SOC_START_VALUE', 'Value'].values[0]


# Some Constants for the Series case
BUS_LENGTH_SERIES = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'BUS_LENGTH_SERIES', 'Value'].values[0]
EM1_PWR_KW_SERIES = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'EM1_PWR_KW_SERIES', 'Value'].values[0]
ENG_PWR_KW_SERIES = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'ENG_PWR_KW_SERIES', 'Value'].values[0]
BATT_CAP_KW_SEC_SERIES = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'BATT_CAP_KW_SEC_SERIES', 'Value'].values[0]
CP1_SERIES = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'CP1_SERIES', 'Value'].values[0]
CP2_SERIES = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'CP2_SERIES', 'Value'].values[0]
#BUS_WEIGHT_TONNES_SERIES = c.SOURCE_MASS_METRIC_TONNES * c.HEV_TO_SI_CI_WEIGHT_FACTOR
SOC_BASE_PERCENT_SERIES = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'SOC_BASE_PERCENT_SERIES', 'Value'].values[0]
SOC_MIN_PERCENT_SERIES = SOC_BASE_PERCENT_SERIES - 5
SOC_DELTA_PERCENT_SERIES = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'SOC_DELTA_PERCENT_SERIES', 'Value'].values[0]
EPT_EFFICIENCY_PERCENT_SERIES = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'EPT_EFFICIENCY_PERCENT_SERIES', 'Value'].values[0]
CD1_SERIES = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'CD1_SERIES', 'Value'].values[0]
CD2_SERIES = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'CD2_SERIES', 'Value'].values[0]
CI1_SERIES = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'CI1_SERIES', 'Value'].values[0]
CI2_SERIES = hybrid_parameter.loc[hybrid_parameter['Parameter'] == 'CI2_SERIES', 'Value'].values[0]
...
#    print negative_count -1 + binned_data_df_parallel['CycleBinCounts'].sum()
    ...
    for index_no in range(len(data_table)):
        ...
        # B_out calculation
        data_table_dict[B_OUT_SERIES][index_no] = min(((max(power, 0) / ( c.INVERTER_EFFICIENCY * c.MOTOR_EFFICIENCY * c.BATTERY_EFFICIENCY)) + (AUX_E_LOAD_SERIES/0.9)) , EM1_PWR_KW_SERIES + AUX_E_LOAD_SERIES)  
...
#    data_table[ABS_TRACTIVE_POWER] = data_table.stp.abs() * FIXED_MASS_FACTOR
    data_table[ABS_TRACTIVE_POWER] = data_table.stp * FIXED_MASS_FACTOR
    uncounted_work_pos = data_table.loc[(data_table[NEW_BIN_1_SERIES] == -1) & (data_table[ABS_TRACTIVE_POWER] >= 0), ABS_TRACTIVE_POWER].sum()
    uncounted_work_neg = data_table.loc[(data_table[NEW_BIN_1_SERIES] == -1) & (data_table[ABS_TRACTIVE_POWER] < 0), ABS_TRACTIVE_POWER].sum()
    
#    AUX_E_LOAD_SERIES
    # Initlialize the new column to be created
    binned_data_df_series[CYCLE_OBSERVED_WORK] = binned_data_df_series.Fraction
#    print(binned_data_df_series.head(10))
    ...
    binned_data_df_series.loc[1, CYCLE_OBSERVED_WORK] += uncounted_work_pos / 3600
    binned_data_df_series.loc[0, CYCLE_OBSERVED_WORK] += uncounted_work_neg / 3600
